 ...
 * 
 */
@WebServiceClient(name = "WebServiceImplService", targetNamespace = "http://Impl.server.atguigu.com/", wsdlLocation = "http://localhost:8080/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICEIMPLSERVICE_QNAME = new QName("http://Impl.server.atguigu.com/", "WebServiceImplService");
    ...
    public WebServiceImpl getWebServiceImplPort() {
        return super.getPort(new QName("http://Impl.server.atguigu.com/", "WebServiceImplPort"), WebServiceImpl.class);
    }
    ...
    public WebServiceImpl getWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Impl.server.atguigu.com/", "WebServiceImplPort"), WebServiceImpl.class, features);
    }
